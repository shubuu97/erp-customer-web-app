        ...
        <div className="left-sidebar">
            ...
            <div className="left-sidebar-category">
                ...
                <div className="category-priceRange checkbox-custom">
                    <label>
                        <input type="checkbox" onChange={(e)=>props.applyPriceRangeFilter('lessThan50', e.target.checked)}/>
                        <span className="term-conditions">Under $50</span>
                    </label>
                </div>
                <div className="category-priceRange checkbox-custom">
                    <label>
                        <input type="checkbox" onChange={(e)=>props.applyPriceRangeFilter('from50To100', e.target.checked)}/>
                        <span className="term-conditions">$50 - $100</span>
                    </label>
                </div>
                <div className="category-priceRange checkbox-custom">
                    <label>
                        <input type="checkbox" onChange={(e)=>props.applyPriceRangeFilter('from100To200', e.target.checked)}/>
                        <span className="term-conditions">$100 - $200</span>
                    </label>
                </div>
                <div className="category-priceRange checkbox-custom">
                    <label>
                        <input type="checkbox" onChange={(e)=>props.applyPriceRangeFilter('above200', e.target.checked)}/>
