        ...
        <div className="descriptionContent">
          <div className="namePriceDiv">
            ...
            <div className="price-text-css">
              <h3 className="p-price">{props.detail.currency && props.detail.currency.code || ''} {props.updatedPrice || (props.detail.basePrice && props.detail.basePrice.price)}</h3><p>Per {props.selectedWeight.label || ((props.detail.basePrice && props.detail.basePrice.unitCount) + ' ' +(props.detail.primaryUomCode && props.detail.primaryUomCode.name) || 'Grams')}</p>
            </div>
