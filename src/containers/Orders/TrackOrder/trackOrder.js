...
export default class TrackOrders extends React.Component {
    ...
    render() {
                ...
                <div>
                    <div className="to-content-row">
                            ...
                            <div className="to-status">
                                <label>{this.props.partPackaged.displayName || 'PART PACKAGED'}</label>
                    ...
                    <div className="to-content-row">
                            ...
                            <div className="to-border"></div>
                            <div className="to-status">
                                <label>{this.props.partDispatched.displayName || 'PART DISPATCHED'}</label>
                    ...
                    <div className="to-content-row">
                        ...
                        <div className="to-border"></div>
                        <div className="to-status">
                            <label>{this.props.partDelivered.displayName || 'PART DELIVERED'}</label>
                            <span>{this.props.partDelivered.date ? moment(this.props.delivered.date).format('DD MM YYYY, hh:mm: a') : 'will be update soon' }</span>
                        </div>
                    </div>
                </div>
            )
        ...
        const renderHistroyData = this.props.trackData.map(data => {
            return (
                <div>
            ...
            <div className="to-content">
                ...
                {renderHistroyData()}
                    <div className="to-content-row active">
                        ...
                        <div className="to-border"></div>
                        <div className="to-status">
                            <span>{this.props.placedOn.displayName ? this.props.placedOn.displayName : 'PLACED ON'}</span>
                    ...
                    <div className="to-content-row active">
                        ...
                        <div className="to-border"></div>
                        <div className="to-status">
                            <span>{this.props.accepted.displayName ? this.props.accepted.displayName : 'ACCEPTED ON'}</span>
                    ...
                    {this.props.partPackaged.isTrue ? partOrder : withoutPart}
