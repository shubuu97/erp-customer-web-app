      ...
      <div className="order-card">
        <div className="order-card-header">
          <div style={{width:'100%'}} className="card-header-left">
            ...
            <div className="track-item"><label className="track-status">{this.props.status.charAt(0).toUpperCase()+this.props.status.slice(1).toLowerCase()}</label><span className="order-track-date">{moment(this.props.placedDate).format('DD MMMM YYYY')}</span></div>
