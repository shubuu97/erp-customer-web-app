        ...
        <div className="row d-flex">
            ...
            {fields.map((license, index) => (
                ...
                <div className="form-d col-md-4 col-sm-6 form-input">
                    ...
                    <Field label='License Number <em>*</em>' name={`${license}.licenseNumber`} component={TextFieldInput} />
    ...
    return (
        ...
        <div className="col-sm-12">
            ...
            {fields.map((address, index) => (
                ...
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='Site Address <em>*</em>' name={`${address}.siteAddress`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='Contact Number <em>*</em>' name={`${address}.contactNumber`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='Email <em>*</em>' name={`${address}.email`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='Zip Code <em>*</em>' name={`${address}.zipCode`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='Country <em>*</em>' name={`${address}.country`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='State <em>*</em>' name={`${address}.state`} component={TextFieldInput} />
                </div>
                <div className="form-d col-md-4 col-sm-6 form-input">
                    <Field label='City <em>*</em>' name={`${address}.city`} component={TextFieldInput} />
                </div>
...
<div class="row d-flex">
          ...
          <div className="form-d col-md-4 col-sm-6 form-input">
           <Field name={`${site}.siteName`} component={TextFieldInput} label="Site Name <em>*</em>"/>
           </div>
           <div className="form-d col-md-4 col-sm-6 form-input">
           <Field name={`${site}.licenseType`} options={prop.siteLicenceType} component={ReactSelectWrapper} placeholder='License Type <em>*</em>'/>
           </div>
