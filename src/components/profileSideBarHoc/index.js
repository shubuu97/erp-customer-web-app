...
const profileSideBar = (WrappedComponent) => {
  ...
  return class Enhancer extends Component {
    ...
    render() {
      console.log("in side base render",this.props.location.pathname);
            ...
            <div className="row">
              <div className="col-md-3 col-sm-4">
                <div className="profile-sidebar">
                  <ul>
                    <li className={`${(this.props.location.pathname == '/CompanyStaticProfileView' || this.props.location.pathname == '/StaticProfileView'||this.props.location.pathname=="/companyProfile"||this.props.location.pathname=="/customerProfile" ||this.props.location.pathname=="/reset") ? 'active' : ''}`} onClick={() => this.handleMenuClick()}>My Profile</li>
